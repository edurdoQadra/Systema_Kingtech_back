...
Route::group(['prefix' => 'v4'], function () {
    ...
    // Route::post('/create', [TransaccionesController::class, 'store']);
    // Route::get('/client/{id}', [TransaccionesController::class, 'show']); // Cambio de "{matriz}" a "{id}"
    // Route::put('/client/{id}', [TransaccionesController::class, 'update']); // Cambio de "{matriz}" a "{id}"
    // Route::delete('/delete/{id}', [TransaccionesController::class, 'destroy']); // Cambio de "{matriz}" a "{id}"
});
